...
void Sys_Init (void)
{
	...
	if (vinfo.dwPlatformId == VER_PLATFORM_WIN32s)
		...
		s_win95 = true;
#else
	s_win95 = false; // All this just to disable alt-tab
	// this won't be compatable with windows 95 anymore..woopddo
...
#ifdef _DEBUG
	// open the dell in the same directory
	Com_sprintf(name, sizeof(name), "%s",  gamename);
#else
